...
public class ConnectProtocol {
    ...
    public static class Assignment {
        ...
        public void AddTask(ConnectorTaskId Task) {
        	taskIds.add(Task);
        }
        
        public void RemoveConnector(String Connector) {
        	Iterator<String> it = connectorIds.iterator();
        	while(it.hasNext()){
        	    String oneconnector = it.next();
        	    if(oneconnector.equals(Connector)){
        	        it.remove();
        	    }
        	}
        }
        
        public void RemoveTask(ConnectorTaskId Task) {
        	Iterator<ConnectorTaskId> it = taskIds.iterator();
        	while(it.hasNext()){
        		ConnectorTaskId onetask = it.next();
        	    if(onetask.connector().equals(Task.connector())){
        	        it.remove();
        	    }
        	}
        }
